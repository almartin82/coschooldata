...
class TestImport:
    ...
    def test_import_functions(self):
        ...
        import pycoschooldata as co
        assert hasattr(co, 'fetch_enr')
        assert hasattr(co, 'fetch_enr_multi')
        assert hasattr(co, 'tidy_enr')
        assert hasattr(co, 'get_available_years')

    def test_version_exists(self):
        """Package has a version string."""
        import pycoschooldata as co
        assert hasattr(co, '__version__')
        assert isinstance(co.__version__, str)
