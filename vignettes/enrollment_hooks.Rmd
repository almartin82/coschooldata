...
can_fetch <- tryCatch({
  httr::GET("https://www.cde.state.co.us/cdereval/pupilcurrent", httr::timeout(5))
  TRUE
...
This vignette explores Colorado's public school enrollment data, surfacing key trends and demographic patterns across 7 years of data (2019-2025).
